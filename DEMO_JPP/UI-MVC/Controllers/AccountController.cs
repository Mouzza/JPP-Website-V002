    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    ViewBag.errorMessage = "Uw moest een geconfirmeerde mail hebben om in te loggen.";
                    return View("Error");
                }
            }
        ...
        public ActionResult MakeActivatedAccount()
        {
            return View();
        }
        ...
        [Authorize(Roles = "Admin")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> MakeActivatedAccount(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // Send an email with this link
                 ...
                 await UserManager.SendEmailAsync(user.Id, "Reset Password", "Reset uw wachtwoord door <a href=\"" + callbackUrl + "\">hier</a> te klikken aub");
                 ViewBag.Link = callbackUrl;
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new User { UserName = model.Naam, Email = model.Email, Created = DateTime.Now };
